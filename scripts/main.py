...
def on_ui_tabs():
    with gr.Blocks(analytics_enabled=False) as threeDModel_loader:
        ...
        model_scale_page.change(None, [model_scale_page], None, _js="updateModel")
        has_ground_page.change(None, [has_ground_page], None, _js="setGroundVisible")
        has_ground_grid_page.change(None, [has_ground_grid_page], None, _js="setGroundGridVisible")
        has_axis_page.change(None, [has_axis_page], None, _js="setAxisVisible")
        color_page.change(None, [color_page], None, _js="setBGColor")

async function _import() {
	if (!globalThis.threeDModelLoader || !globalThis.threeDModelLoader.import) {
		...
		return await globalThis.threeDModelLoader.imports.three();
	}
}

async function _import_fflate_unzlibSync() {
	if (!globalThis.threeDModelLoader || !globalThis.threeDModelLoader.import) {
		return await import('fflate-unzlibSync');
	} else {
		return await globalThis.threeDModelLoader.imports.fflateUnzlibSync();
	}
}
...
const {
    unzlibSync
} = await _import_fflate_unzlibSync();
